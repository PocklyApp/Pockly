...
func TestFormatClaudeCommandStatusAvoidsStableIdentifiers(t *testing.T) {
	...
	for _, want := range []string{"Pockly daemon linked", "Remote access: enabled", "https://pockly.example/workspace/sessions"} {
