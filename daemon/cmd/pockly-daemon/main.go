...
// pockly.example can read history and inject prompts back into running agents.
//
...
func runSetup(args []string) (err error) {
	...
	fs.SetOutput(os.Stderr)
	relayURL := fs.String("relay-url", "https://pockly.example", "relay base URL")
	...
	if *installService {
		...
		fmt.Println("Open https://pockly.example/workspace/sessions on your phone to view and control sessions.")
	} else {
...
func runPair(args []string) error {
	...
	fmt.Printf("Open pockly.example, log in, and paste or scan the payload above.\n")
...
<Task version="1.2" xmlns="http://schemas.microsoft.com/windows/2004/02/mit/task">
  <RegistrationInfo>
    <Description>Pockly daemon - keeps your local Claude sessions reachable from pockly.example.</Description>
