...
if ([string]::IsNullOrWhiteSpace($BaseUrl)) { $BaseUrl = "https://cdn.pockly.example/pockly-daemon" }
if ([string]::IsNullOrWhiteSpace($RelayUrl)) { $RelayUrl = "https://pockly.example" }
